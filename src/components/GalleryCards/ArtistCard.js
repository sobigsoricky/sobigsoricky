...
import  ArtistImg  from '../../assets/img/datascientist.jpg';
    ...
    return(
        <>
            <Card className={classes.card}>
                <img className={classes.image} src={ArtistImg   }></img>
                <div className={classes.icon}>
                    <p className={classes.count}>1k+</p>
                </div>
                <Typography className={classes.title}>BECOMING A PROFESSIONAL ARTIST</Typography>
