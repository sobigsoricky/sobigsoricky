...
import StyledCheckbox from "../Signup/StyledCheckbox";
...
export default function CourseList(props) {
  ...
  const pq = async () => {
    await onGetData(
      "api/user/subject/getSubSubjectBySlug/" + query.get("pro")
    )
      .then((res) => {
...
console.log(query.get("pro"));
  return (
    <>
     <Helmet>
          <title>{Name} | List of Free Online Courses</title>
          <meta name="description" content={`List of professional courses in ${Name}`} />
        </Helmet>
      {/* <NavbarOther /> */}
