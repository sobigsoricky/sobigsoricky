...
import { NavbarOther, CourseCard, CourseMenu, Loading } from "../components"
...
export default function CourseList(props) {
  ...
  return (
    <>
      <Helmet>
        <title> List of Free Online Courses</title>
        <meta name='description' content={`List of professional courses `} />
      </Helmet>
      <NavbarOther />
