...
export default function BlogPost(props) {
  ...
  useEffect(() => {
    googleAnalyticsAction();
    ContentfulClient.getEntry(props.match.params.slug)
      .then((response) => {
        setAllBlogData(response.fields)
            ...
            <>
              ...
              <Typography className={classes.blogcontent}>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: marked(AllBlogData.description),
                  }}
                  className={classes.blogcontent1}
                ></div>
                {/* {BlogDescription} */}
              </Typography>
              ...
              <div className={classes.author}>
                <div className={classes.section}>
                  <Circle>
                    {AllBlogData.authorImage === null ||
                    AllBlogData.authorImage === "" ? (
                      ""
                    ) : (
                      <img
                        src={AllBlogData.authorImage.fields.file.url}
              ...
              <div className={classes.commentSection}>
                ...
                <div className={classes.showreview}>
                  <>
                    <img
                      src={anonymous}
                      className={clsx(classes.dp, classes.desktop)}
                      alt=''
                    />
                  </>
                  <div className={classes.reviews}>
                    ...
                    <Typography className={classes.comment}>
                      Lorem ipsum dolor sit amet, fabulas molestiae nam ad, eos
                      an sonet deleniti volutpat. Mel sonet persecuti
